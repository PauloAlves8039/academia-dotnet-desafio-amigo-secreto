...
namespace Academia.DotNet.AmigoSecreto.App.Data
{
    public class Persistencia
    {
        ...
        private string caminhoDoArquivoAmigos => Path.Combine(localizacao, "amigos.csv");
        private string caminhoDoArquivoSecretos => Path.Combine(localizacao, "secretos.csv");
